        ...
        <AnimatePresence mode="wait">
          ...
          {view === "photos" && (
            <motion.div key="photos" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              {/* Ultra-Premium Letter Reveal Intro */}
              <motion.div
                initial={{ opacity: 1 }}
                animate={{ opacity: 0 }}
                ...
                style={{
                  ...
                  background: "#050505", pointerEvents: "none"
                }}
              >
                <div style={{ position: "relative", textAlign: "center" }}>
                  <div style={{ display: "flex", gap: "2px" }}>
                    {"PHOTOGRAPHIC".split("").map((letter, i) => (
                      <motion.span
                        key={i}
                        ...
                        style={{
                          ...
                          fontStyle: "italic",
                          background: "linear-gradient(135deg, #fff 0%, #ff6b81 25%, #e8c547 50%, #4ade80 75%, #22d3ee 100%)",
                  ...
                  {/* High-End Reflection */}
                  <div style={{ display: "flex", gap: "2px", opacity: 0.1, transform: "scaleY(-1) translateY(10px)", filter: "blur(4px)" }}>
                    {"PHOTOGRAPHIC".split("").map((letter, i) => (
                      <motion.span
                        key={i}
                        initial={{ opacity: 0 }}
                    ...
                    {"CINEMATIC".split("").map((letter, i) => (
                      <motion.span
                        ...
                        style={{
                          ...
                          fontFamily: "var(--font-heading)",
                          fontStyle: "italic",
                          background: "linear-gradient(135deg, #fff 0%, #22d3ee 25%, #4ade80 50%, #e8c547 75%, #ff6b81 100%)",
                          backgroundSize: "200% auto",
                          WebkitBackgroundClip: "text",
                          WebkitTextFillColor: "transparent",
                          backgroundClip: "text",
